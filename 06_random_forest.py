...
class RandomForestExperiment:
    ...
    def train_model(self, n_estimators: int = 500, random_state: int = 42):
        ...
        print(f"Treinando Random Forest com {n_estimators} árvores")
    ...
    def calibrate_max_features(self, n_estimators: int = 500):
        
      
        print("CALIBRAÇÃO DE MAX_FEATURES COM CROSS-VALIDATION")
        ...
        # Listar max_features a testar
        max_features_list = [
            'sqrt',                           # √features
            'log2',                           # log2(features)
            1,                                # 1 feature
            max(2, n_features // 3),          # n_features / 3
            max(3, n_features // 2),          # n_features / 2
            n_features                        # Todas as features
        ]
        
        # Remover duplicatas mantendo ordem
        max_features_list = list(dict.fromkeys(max_features_list))
        
        print(f"Testando max_features: {max_features_list}")
        ...
        print(f"\nExecutando Cross-Validation para cada max_features...")
        for max_feat in max_features_list:
            print(f"  Testando max_features={max_feat}...")
        ...
        print(f"\n[Resumo de Todos os max_features Testados]")
        results_summary = pd.DataFrame({
            'max_features': [r['max_features'] for r in all_results],
...
if __name__ == "__main__":
    experiment = RandomForestExperiment(
    ...
    # Pipe 3: Calibração de max_features
    print("\n\nPipe 3: Calibração de Hiperparâmetros")
    experiment.calibrate_max_features(n_estimators=500)
