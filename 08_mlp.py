...
class MLPClassifierExperiment:
    ...
    def calibrate_activations(self):
        ...
        print("CALIBRAÇÃO DE ATIVAÇÕES COM CROSS-VALIDATION")
        ...
        activation_list = list(dict.fromkeys(activation_list))
        
        print(f"Testando funções de ativação: {activation_list}")
...
if __name__ == "__main__":
    experiment = MLPClassifierExperiment(
    ...
    # Pipe 3: Calibração de max_features
    print("\n\nPipe 3: Calibração de Hiperparâmetros")
    experiment.calibrate_activations()
